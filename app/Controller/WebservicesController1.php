 ...
 */
	...
	exit;
        ...
        $this->autoRender = false;
            ...
            foreach($data->results[1]->address_components as $addressComponent) {
            if(in_array('bus_station', $addressComponent->types)) {
         ...
         /*$this->request->employes = '[{"empid":"046B3C52873680","longitude":"78.4652","latitude":"17.04215","date":"20150729_163024","status":"Entry"},
                     {"empid":"046B3C52873680","longitude":"78.4766861","latitude":"17.4010044","date":"20150729_163024","status":"Entry"},
                     {"empid":"046B3C52873680","longitude":"78.4652","latitude":"17.04215","date":"20150729_163024","status":"Exit"}]';*/
